...
const desc="Sistinctively provide acces mutfucto users whereas transparent process somes ncentivize eficient functionalities rather than extensible archtecture communicate leveraged services and cross-platform";

const year="30+";
const expareance="Years Of Experences";
const aboutList=[
    {
      imgUrl:'/src/assets/images/about/icon/01.jpg',
      imgAlt:'about icon akanksha',
